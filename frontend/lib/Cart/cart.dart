...
import '../Notifications/widget/notification.dart';
                      ...
                      return  Column(
                        children: [
                          Container(
                              ...
                              child: _cartModel == null ? const TextNotificationHeading(text: "No items in cart") : CartItem(
                                cartItemPk: _cartModel!.dataList[index].orderId!, cart: _cartModel!.dataList[index],
