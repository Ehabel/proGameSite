...
class SignUpButtonAccount extends StatefulWidget {
  VoidValue callBackSignUp;
  IconData icon;
  Color color;
  String label;
  double radius;
  SignUpButtonAccount({Key? key,
    required this.label,
    required this.color,
    required this.icon,
  ...
  @override
  State<SignUpButtonAccount> createState() => _SignUpButtonAccountState();
}

class _SignUpButtonAccountState extends State<SignUpButtonAccount> {
